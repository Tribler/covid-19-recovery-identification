...
RUN yes | android-sdk-linux/tools/bin/sdkmanager --sdk_root=${ANDROID_HOME} \
    ...
    "ndk;${ANDROID_NDK}" "platform-tools" "emulator" "system-images;android-29;google_apis;x86"
    # "system-images;android-30;google_apis;x86" "system-images;android-28;google_apis_playstore;x86" \
