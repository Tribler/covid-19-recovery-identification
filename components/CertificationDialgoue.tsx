...
const CertificationDialogue: React.FC<DialogueProps> = ({type, attester, visible, setVisible}:DialogueProps) => {
    ...
    return (
      ...
      >
        <Dialog
            ...
            <Dialog.Content>
                <Text style ={{fontWeight:'bold'}}>Are you sure you want to add {attributeTypeMap[parseInt(type)].value} to your chain? </Text>
                <Text>Data in your chain is only accessible through your explicit authorization</Text>
            </Dialog.Content>
            <Dialog.Actions>
              <Button accessibilityStates mode='contained' style={{width: 80, marginRight:50, backgroundColor:'green'}} onPress={addAttribute}>ADD</Button>
