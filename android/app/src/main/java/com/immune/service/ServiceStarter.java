...
//
//    protected static final ArrayList<String> intentStart = new ArrayList<>(Arrays.asList(
//            Intent.ACTION_USER_PRESENT, Intent.ACTION_BOOT_COMPLETED, "com.immune.START_SERVICE"));
//    protected static final ArrayList<String> intentStop = new ArrayList<>(Arrays.asList(
