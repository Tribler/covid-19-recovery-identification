...
import {StyleSheet, Text, View, YellowBox, ScrollView, FlatList, Alert} from 'react-native';
      ...
      <View style={state.darkMode ? styles.dark : styles.light}>
        ...
        <View style={{width: '95%'}}>
          <Dropdown
            ...
            label="Certificates..."
            fontSize={20}
            onChangeText={(value: string, _index: number) => setCertificateType(value)}
        ...
        <Button
          ...
          onPress={() => {
            if (certificateType == '') throw Alert.alert('You have not picked a certificate type yet!');
